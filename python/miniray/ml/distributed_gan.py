...
from .gan_cifar10 import Generator, Discriminator
...
class DistributedGANWorker:
    ...
    def __init__(self, worker_id, latent_dim=100, lr=0.0002, device='cpu'):
        self.worker_id = worker_id
        self.latent_dim = latent_dim
        self.lr = lr
        self.device = device

        print(f"[Worker {worker_id}] 初始化分布式 GAN Worker")
...
class DistributedImageGenerator:
    ...
    def __init__(self, worker_id, latent_dim=100, device='cpu'):
        self.worker_id = worker_id
        self.latent_dim = latent_dim
        self.device = device
        self.generator = None
